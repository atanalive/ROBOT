...
void analytic_data_in_vision(void)
{
	...
	if(ROBOT_VISION==VISION_START_RECEIVE)//发送0x01表示请求树莓派判断物料颜色和位置并返回信息
	{
